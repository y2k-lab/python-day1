...
[観点を選んだ理由]
分岐があるから
条件分岐があり、入力によって結果が変わるため、想定した分岐に正しく
入るかを確認する目的で選んだ
...
[観点を選んだ理由]
想定外入力が来るから
空文字入力やスペースのみの入力は現実的に起こりうるため、
想定外入力時の挙動を確認する目的で選んだ
...
[観点を選んだ理由]
想定外入力が来るから
仕様で定義されてない入力が渡された場合に、
else分岐へ正しく処理されるか確認するため

-入力: choice1='left' choice2='wait' choice3=`green`
...
- 入力:letter=3, number=2, symbol=1

- 期待結果:アルファベット３文字　記号２文字　数字１文字の
　　　　　　合計６文字のパスワードが表示される

- 実行結果:`Your password is: my)1z( のみ表示された
